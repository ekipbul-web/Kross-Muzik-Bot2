...
client.once('ready', () => {
    // Render konsolunda botunuzun ismi görünecek
    console.log(`🤖 Kross Müzik Bot² aktif edildi! Müzik sistemleri hazır.`);
    
    // Botun Discord üzerindeki "Oynuyor..." durum mesajı
...
async function playSong(guildId, song) {
    ...
    try {
        ...
        // Kross Müzik Bot² Özel Panel Tasarımı
        const embed = new EmbedBuilder()
            .setColor('#16a085') // Kross markasına özel şık turkuaz rengi
